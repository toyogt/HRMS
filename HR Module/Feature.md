...
- `POST /api/machine/device/details` (Phase 1)
- `POST /api/machine/time/read` (Phase 1)
- `POST /api/machine/time/set` (Phase 1)
- `POST /api/machine/logs/general/read` (Phase 1)
- `POST /api/machine/capabilities/probe` (Phase 1)
